...
//        getService();
    ...
    PublishSubject<ActivityLifeCycleEvent> lifeCycleEventPublishSubject=PublishSubject.create();
    private void getService(){
        RequestClient.getService("wzm", lifeCycleEventPublishSubject, new CallBackLis<JsonElement>() {
            @Override
            public void onSuccess(String method, JsonElement content) {
